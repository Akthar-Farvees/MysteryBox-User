...
var Signer = /** @class */ (function () {
    ...
    */
    Signer.sign = function (request, accessInfo, serviceInfo) {
        ...
        var requestToSign = tslib_1.__assign(tslib_1.__assign({}, request), { body: request.data, url: new URL(request.url) });
...
var getOptions = function (request, accessInfo, serviceInfo, expiration) {
    ...
    var credentials = tslib_1.__assign({ accessKeyId: access_key, secretAccessKey: secret_key }, (sessionTokenRequiredInSigning(service)
        ? { sessionToken: session_token }
        : {}));
    return tslib_1.__assign({ credentials: credentials, signingDate: Util_1.DateUtils.getDateWithClockOffset(), signingRegion: region, signingService: service }, (expiration && { expiration: expiration }));
};
